...
def register():
    try:
        ...
        new_user = User(first_name=first_name.capitalize(), last_name=last_name.capitalize(), role=role, is_admin=is_admin, email=email, password=bcrypt.generate_password_hash(password1).decode("utf-8"))
